...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/k8s_monolith/configuration/cluster?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
