...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/ovs?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2KernelVLAN?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/SmartVF2SmartVF?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
