...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/two_cluster_configuration/basic/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/two_cluster_configuration/basic/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
