...
func (s *Suite) TestHeal_floating_forwarder_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-forwarder-death/cluster3?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-forwarder-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-forwarder-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestHeal_floating_nse_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster3?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=1m pod -l app=nse-kernel -n ns-floating-nse-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestHeal_floating_nsm_system_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nsm-system-death/cluster3?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nsm-system-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_floating-nsm-system-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/three_cluster_configuration/basic/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/three_cluster_configuration/basic/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/three_cluster_configuration/basic/cluster3?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestHeal_interdomain_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-nsmgr-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-nsmgr-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestHeal_interdomain_proxy_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestHeal_interdomain_registry_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-registry-death/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/interdomain/usecases/heal_interdomain-registry-death/cluster1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
