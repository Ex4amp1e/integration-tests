...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/observability/jaeger_and_prometheus?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl wait -n observability --timeout=1m --for=condition=ready pod -l app=opentelemetry`)
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/observability/jaeger_and_prometheus/example?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
