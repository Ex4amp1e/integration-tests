...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/annotated-namespace?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/features/annotated-namespace/client.yaml`)
...
func (s *Suite) TestChange_nse_dynamically() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/change-nse-dynamically?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/features/change-nse-dynamically/blue-netsvc.yaml`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/features/change-nse-dynamically/green-netsvc.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/dns?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestVl3_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/dual-stack/vl3-dual-stack?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e` + "\n" + `kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/dual-stack/vl3-dual-stack/ipam-ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/exclude-prefixes?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/exclude-prefixes-client?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestMultiple_services() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/multiple-services?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/mutually-aware-nses?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/nse-composition?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/opa?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/policy-based-routing?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/scale-from-zero?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestScaled_registry() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/scaled-registry?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/select-forwarder?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/vl3-dns?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestVl3_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/vl3-ipv6?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestVl3_lb() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/vl3-lb?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/vl3-scale-from-zero?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/features/webhook?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
