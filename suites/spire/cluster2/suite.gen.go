...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG2 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/spire/cluster2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/spire/cluster2/clusterspiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/spire/base/clusterspiffeid-webhook-template.yaml`)
}
func (s *Suite) Test() {}
