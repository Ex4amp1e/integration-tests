...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/remotevlan_vpp?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7873e0d6720e85414e6844db62a8d0f30bad4e5e/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
	r.Run(`kubectl apply -k https://github.com/Ex4amp1e/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3?ref=7873e0d6720e85414e6844db62a8d0f30bad4e5e`)
